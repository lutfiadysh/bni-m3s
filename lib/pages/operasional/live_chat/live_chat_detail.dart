...
class LiveChatOperasionalDetail extends StatefulWidget {
  final String chat_name;
  final String status;
  final String chat;
  LiveChatOperasionalDetail({this.chat_name,this.status,this.chat});
  @override
  _LiveChatOperasionalDetailState createState() => _LiveChatOperasionalDetailState();
}

class _LiveChatOperasionalDetailState extends State<LiveChatOperasionalDetail> {
  @override
